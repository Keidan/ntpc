...
if(DEFINED IS_DEBUG AND IS_DEBUG EQUAL 1 AND NOT DEFINED WIN32)
  ...
  add_custom_command(TARGET gcov
    COMMAND gcov -b ${CMAKE_SOURCE_DIR}/src/ntpc/NTPClient.cpp.gcno -o ${OBJECT_DIR}/src/ntpc/
    COMMAND gcov -b ${CMAKE_SOURCE_DIR}/src/ntpc/UDPSocket.cpp.gcno -o ${OBJECT_DIR}/src/ntpc/
